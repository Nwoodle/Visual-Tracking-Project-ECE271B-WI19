...
% The code has been modified by Xubo Leng to keep it updated.  
...
videos = { 'shaking', 'singer1', 'tiger1', 'trellis'};
...
if ~exist('parpool', 'file'),
	...
	parfor k = 1:numel(videos),
		disp(['Downloading and extracting ' videos{k} '...']);
		unzip(strcat('http://cvlab.hanyang.ac.kr/tracker_benchmark/seq/', videos{k}, '.zip'), base_path);
	end
end
